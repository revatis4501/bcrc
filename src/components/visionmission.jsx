        ...
        <div className=" py-5">
          ...
          <div className=" py-2">
            <div className="row g-4">
                ...
                <div className="card card-custom border-mission text-center">
                  ...
                  <div className="px-4 pb-4">
                    ...
                    <p className="text-muted small">
                      ...
                      2) To arrange training program for various officials of
                      BCs and other agencies involved with FI activities and
                      formulate training manual/ inputs,research papers as part
                      of capacity building of BCs/ CSPs and others <br />
                      ...
                      <br />
                      4) To collaborate with stakeholders to achieve our goal
                      ,of enabling the left out or poorly or inadequately served
                      by the financial sector through better financial
                      reach,products and technology
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-6 col-lg-4">
                <div className="card card-custom border-mission text-center">
                  <div className="bg-primary card-custom2"></div>
                  <div className="d-flex align-items-center justify-content-center mt-2 mb-3">
                    <img
                      src={idea}
                      alt="Goal Icon"
                  ...
                  <div className="px-4 pb-4">
                    ...
                    <p className="text-muted small">
                      ...
                      suggest for deep penetration of the channel with viability
                      and sustainability on clear focus <br />
              ...
              <div className="col-12 col-md-6 col-lg-4">
                <div className="card card-custom border-mission text-center">
                  ...
                  <div className="px-4 pb-4">
                    ...
                    <p className="text-muted small">
                      Our core values are the principles that guide us in
                      helping the unprivileged and vulnerable section of people
                      to achieve financial literacy and prosperity. We strive to
                      make Business Correspondents as financial services leaders
                      and trusted channel that is differentiated by personalised
                      ...
                      collaborative. We will contribute to grow further in the
                      FI field <br />
